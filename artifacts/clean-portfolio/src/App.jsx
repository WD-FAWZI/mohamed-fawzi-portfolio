...
import { Github, Linkedin, Mail, ExternalLink, ChevronDown, Code2, Brain, Server, Download, Youtube, Stethoscope } from "lucide-react";
...
const skills = [
  { icon: <Code2 size={20} />, label: "Frontend", items: ["React", "Next.js", "TypeScript", "Tailwind CSS", "Three.js", "Vite & Monorepo Architecture", "Vibe Coding / AI UI"] },
  { icon: <Brain size={20} />, label: "AI & Architecture", items: ["LLM Orchestration", "Local LLMs (Ollama)", "Agentic Workflows (Vapi)", "Prompt Caching", "Voice AI Agents", "BCI (Brain-Computer Interfaces)"] },
  { icon: <Server size={20} />, label: "Backend & Infra", items: ["FastAPI", "Node.js", "Supabase", "Vercel", "Python"] },
  { icon: <Stethoscope size={20} />, label: "Health-Tech & Product", items: ["Medical Data Systems", "Product Design", "Healthcare Platforms"] },
];
